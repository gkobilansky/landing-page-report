      ...
      <div className="group flex items-center space-x-4 bg-gray-800/90 backdrop-blur-sm border border-gray-700 rounded-lg pl-2 pr-4 py-2">
        ...
        <div className="flex space-x-2">
          <a
            ...
            aria-label="GitHub"
          >
            <svg aria-label="Github" className='w-5 h-5' fill="currentColor" viewBox='0 0 92 98' xmlns="http://www.w3.org/2000/svg">
          ...
          <a
            ...
            aria-label="Threads"
          >
            <svg aria-label="Threads" className='w-5 h-5' fill="currentColor" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
